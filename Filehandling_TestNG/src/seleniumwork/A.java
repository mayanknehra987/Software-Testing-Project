...
public class A {
	...
	public void handleFrame2(String frameXpath,WebDriver driver){
   ...
   public void TC001() throws ElementNotInteractableException {
	...
	try {
		...
		obj.handleFrame("//iframe[@id='childIFrame']");
	...
	driver.findElement(By.xpath("//input[@name='vendorCode']")).click();
	handleFrame("//iframe[@id='vendorDialogIFrame']");
	WebElement vendorClick = (driver.findElement(By.xpath("//input[@id='gs_vendorCode_pl']")));
	vendorClick.sendKeys("ven1");
	vendorClick.sendKeys(Keys.ENTER);
	driver.findElement(By.xpath("//td[contains(text(),'ven1')]")).click();
	driver.findElement(By.xpath("//*[@id=\"selectVendor\"]")).click();
	//driver.switchTo().defaultContent();
	handleFrame1();
	handleFrame("//iframe[@id='SKUMaster_IFrame']");
	driver.findElement(By.xpath("//*[@id='SearchBtn']")).click();
	driver.findElement(By.xpath("//span[contains(text(),'YAD1')]")).click();
	driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
	driver.switchTo().defaultContent();
	handleFrame("//iframe[@id='SKUCreateEdit-YAD1_IFrame']");
	//driver.switchTo().frame(driver.findElement(By.cssSelector("iframe[id='SKUCreateEdit-YAD1_IFrame']")));
	driver.findElement(By.xpath("//*[@id='addNewSKU']")).click();
	Select objSelect = new Select(driver.findElement(By.cssSelector("select[id='SKUClassification']")));
	objSelect.selectByIndex(6);
	driver.findElement(By.cssSelector("button[name='addNewSKU']")).click();
	System.out.println(driver.findElement(By.name("skuMaintDTO.style")).isEnabled());
}
	else{
